...
const SuccessWall = () => {
    ...
    // Exact card color rotation from the ReviewSlider logic
    const cardColors = [
    ...
    return (
        <section className="py-24 md:py-32 bg-[#f1fcf9] overflow-hidden" id="success-wall">
            <div className="container mx-auto px-6">
                ...
                {/* 1. TOP SECTION: Centered Header (Matched exactly to ReviewSlider structure) */}
                ...
                {/* 2. MIDDLE SECTION: The Slider (Exactly matching the ReviewSlider's peeking logic) */}
                <div className="relative h-[550px] mb-16">
                    <Swiper
                        ...
                        slidesPerView={1.2}
                        loop={true}
                        centeredSlides={true} // 🆕 Keeps the active achievement in the middle
                        autoplay={{
                            delay: 4000,
                ...
                {/* 3. BOTTOM SECTION: Navigation Buttons (Exactly matching the ReviewSlider placement) */}
