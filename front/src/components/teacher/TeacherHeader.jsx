...
const TeacherHeader = () => {
  ...
  const scrollToSection = (id) => {
    ...
    if (element) {
      // Adjusted offset for the smaller header
  ...
  return (
    <header className="fixed top-0 left-0 right-0 z-50 bg-[#f7fdfd]/90 backdrop-blur-xl border-b border-gray-100">
      <div className="w-full mx-auto px-6 lg:px-12">
        {/* Reduced height from h-36 to h-20 (mobile) and h-24 (desktop) */}
        <div className="flex items-center justify-between h-20 lg:h-24">
          
          {/* 1. Logo - Resized for a cleaner look */}
          ...
          {/* 2. Desktop Nav - Balanced font size and spacing */}
          ...
          {/* 3. Action Buttons - More compact Sign Out */}
