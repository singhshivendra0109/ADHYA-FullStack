...
# #         raise HTTPException(status_code=403, detail="Only students can book teachers")
...
# #     # If approving, check one last time for conflicts
...
# #         if conflict:
# #             raise HTTPException(status_code=400, detail="You already have an accepted booking for this slot.")
...
#     current_user: models.User = Depends(oauth2.get_current_user)
# ):
#     """Fetches all hire requests made by the logged-in student."""
...
#     current_user: models.User = Depends(oauth2.get_current_user)
# ):
#     """Fetch all bookings made by the logged-in student."""
#     if current_user.role != "student":
...
def withdraw_booking(
    ...
    # Optional: Prevent deleting if the teacher already accepted it
