...
# --- 3. UPDATE TEACHER PROFILE (PATCH - Fixes 405 Error) ---
...
def update_teacher_profile(
    ...
    """Allows teachers to update their profile data."""
    if current_user.role != "teacher":
...
# --- 4. DISCOVERY: UPDATED WITH ADVANCED FILTERS ---
